...
#SBATCH --output=outputs/out/ukbb/supervised/unet/multi_modal/exp4-%A.out  # Standard output  %A adds the job id
#SBATCH --error=outputs/err/ukbb/test/supervised/unet/multi_modal/exp4-%A.err  # Standard error 
