...
#SBATCH --output=outputs/out/ukbb/supervised/exp4-%A.out  # Standard output  %A adds the job id
#SBATCH --error=outputs/err/ukbb/train/supervised/exp4-%A.err  # Standard error 
