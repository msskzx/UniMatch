#!/bin/bash
#SBATCH --job-name=ukbb_unimatch_unet_exp1
#SBATCH --output=outputs/out/ukbb/ukbb_unimatch_unet_exp1-%A.out  # Standard output  %A adds the job id
#SBATCH --error=outputs/err/ukbb/test/ukbb_unimatch_unet_exp1-%A.err  # Standard error 
